...
class DPTGSHead(nn.Module):
    ...
    def forward(
        ...
        # print("frames_chunk_size", frames_chunk_size)
        ...
        # print("feature only 1", self.feature_only)
        for frames_start_idx in range(0, S, frames_chunk_size):
            frames_end_idx = min(frames_start_idx + frames_chunk_size, S)

            # print("feature only", self.feature_only)
    ...
    def _forward_impl(
        ...
        # print("direct_img_feat", direct_img_feat.shape)
